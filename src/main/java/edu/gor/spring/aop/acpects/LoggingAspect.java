...
import edu.gor.spring.aop.Book;
...
//    @Pointcut("execution(* edu.gor.spring.aop.UniLibrary.*(..))")
//    private void allMethodsFromUniLibrary() {
//    }
//
//    @Pointcut("execution(public void edu.gor.spring.aop.UniLibrary.returnMagazine())")
...
//    @Pointcut("execution(* edu.gor.spring.aop.UniLibrary.get* ())")
//    private  void allGetMethodsFromUniLibrary() {}
//
//    @Pointcut("execution(* edu.gor.spring.aop.UniLibrary.return* ())")
